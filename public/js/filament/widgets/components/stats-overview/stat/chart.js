...
function xa(i) {
    return (
        i &&
        (i.a < 255 ? `rgba(${i.r}, ${i.g}, ${i.b}, ${mt(i.a)})` : `rgb(${i.r}, ${i.g}, ${i.b})`)
    );
}
...
function yr(i, t) {
    ...
    return (
        e.$shared && (i.options = e = Object.assign({}, e, { $shared: !1, $animations: {} })),
        e
    );
}
function Tn(i, t) {
    ...
    pe = class {
        ...
        unregister(t) {
            let e = this.items,
                ...
                n = this.scope;
            (s in e && delete e[s],
                n && s in V[n] && (delete V[n][s], this.override && delete Ct[s]));
        }
    };
function Pl(i, t, e) {
...
var We = class extends st {
    ...
    getContext() {
        return (
            this.$context || (this.$context = oh(this.chart.getContext(), this, this._tooltipItems))
        );
    }
    getTitle(t, e) {
        let { callbacks: s } = e,
...
var me = class extends Xt {
        ...
        parse(t, e) {
            return A(t) || ((typeof t == 'number' || t instanceof Number) && !isFinite(+t))
                ? null
                : +t;
        }
