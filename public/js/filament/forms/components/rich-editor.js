...
we.prototype = {
    ...
    prepend: function (t) {
        return (
            (t = we.from(t)),
            t.size ? new we(t.content.concat(this.subtract(t).content)) : this
        );
    },
    append: function (t) {
        return (
            (t = we.from(t)),
            t.size ? new we(this.subtract(t).content.concat(t.content)) : this
        );
    },
    subtract: function (t) {
        var e = this;
...
var tr = class t {
    ...
    ne = class t {
        ...
        rangeHasMark(e, n, r) {
            let o = !1;
            return (
                n > e && this.nodesBetween(e, n, (i) => (r.isInSet(i.marks) && (o = !0), !o)),
                o
            );
        }
        get isBlock() {
    ...
    _y =
        ...
        ({ editor: n, tr: r }) => {
            ...
            return (
                ...
                r.setSelection(new I(r.doc.resolve(Math.max(s - 1, 0)))),
                !0
            );
        },
    Vy =
    ...
    let r = Il(t),
        ...
        a = Object.fromEntries(
            i.map((c) => {
                ...
                let m = $(c, 'renderHTML', u);
                return (
                    m && (h.toDOM = (g) => m({ mark: g, HTMLAttributes: on(g, d) })),
                    [c.name, h]
                );
            })
        );
...
Ne.prototype = {
    ...
    tr(t, e, n, r) {
        ...
        let o;
        return (
            e && e.j ? (o = e) : ((o = new Ne(e)), n && r && dn(e, n, r)),
            this.jr.push([t, o]),
            o
        );
    },
                        ...
                        (r.isEditable &&
                            ...
                            r
                                ...
                                .command(({ tr: h }) => {
                                    ...
                                    return (
                                        h.setNodeMarkup(p, void 0, { ...m?.attrs, checked: f }),
                                        !0
                                    );
                                })
                                .run(),
...
var Un = (t, e, n = {}) => {
    ...
    ax = ({
        ...
        let c = (d) =>
            r().callSchemaComponentMethod(o, 'getUploadedFileAttachmentTemporaryUrl', {
                attachment: d,
            });
        return new B({
...
function kk(t, e, n) {
    ...
    if (o instanceof Q) {
        ...
        return (
            (r = yk(r, l.right - l.left, l.bottom - l.top)),
            bp(t.state, t.dispatch, s, l, r),
            !0
        );
    } else if (r) {
        let i = ts(t.state),
