(() => {
    ...
    var ho = Gr((Ws, yr) => {
        (function () {
            ...
            ((X.prototype.update = function (l) {
                ...
                l = h[0];
                for (
                    var v = h[1], p, B = 0, M, I = l.length, Z = this.blocks, ze = this.buffer8;
                    B < I;
                ) {
                    if (
                        (this.hashed &&
                        ...
                        for (M = this.start; B < I && M < 64; ++B) Z[M >>> 2] |= l[B] << m[M++ & 3];
    ...
    function Qi(e, t) {
        ...
        return n &&
            (rn(n) === 'html' || (rn(n) === 'body' && ht(n).position === 'static' && !ei(n)))
            ? r
            : n || ya(e) || r;
    }
    ...
    function ji(e, t, r, n) {
        ...
        let {
            ...
            y = i || o ? [...(d ? Vn(d) : []), ...Vn(t)] : [];
        y.forEach((j) => {
            (i && j.addEventListener('scroll', r, { passive: !0 }),
                o && j.addEventListener('resize', r));
        });
        ...
        function T() {
            let j = vn(e);
            (R &&
                (j.x !== R.x || j.y !== R.y || j.width !== R.width || j.height !== R.height) &&
                r(),
                (R = j),
            ...
            y = async (A) => {
                e.skipDuringClone(async () => {
                    ...
                    (await Xa({ name: L, strategy: Y, el: A, id: A.id || f() }),
                        A.isConnected &&
                            (await O(L), A.isConnected && (S(A), (A._x_async = 'loaded'))));
                })();
            };
        ...
        _dragStarted: function (t, r) {
            if (((In = !1), Ne && N)) {
                (at('dragStarted', this, { evt: r }),
                    this.nativeDraggable && Oe(document, 'dragover', ps));
                var n = this.options;
            ...
            ((In = !1),
                ...
                t &&
                    ...
                    N &&
                        ...
                        Yn &&
                            !In &&
                            ft(N, Qe ? Qe.options.ghostClass : this.options.ghostClass, !1),
            ...
            for (
                ...
                ((r = n[i]),
                    St(r, a.draggable, this.el, !1) &&
                        t.push(r.getAttribute(a.dataIdAttr) || ws(r)));
            return t;
        },
        sort: function (t, r) {
            var n = {},
    ...
    function bs(e, t, r, n, i, o, a, c) {
        ...
        if (!a) {
            if (c && Ar < d * i) {
                if (
                    (!Zn && (Qn === 1 ? f > y + (d * o) / 2 : f < m - (d * o) / 2) && (Zn = !0), Zn)
                )
                    O = !0;
    ...
    var pi = _o(function (e, t, r, n) {
            if (t.scroll) {
                ...
                do {
                    ...
                    var l =
                            ne &&
                            (Math.abs(A - i) <= a && Q + L < V) - (Math.abs(j - i) <= a && !!Q),
                        h =
                            J &&
                            (Math.abs(T - o) <= a && me + Y < de) - (Math.abs(R - o) <= a && !!me);
    ...
    var Os = Object.create,
        ...
        Ps = Bo((e) => {
            ...
            function S(u, s, b) {
                ...
                return (
                    (k || (!k && !b)) &&
                        ((d(s) !== 'body' || E(_)) && (U = f(s)),
                        o(s)
                            ? (($ = t(s)), ($.x += s.clientLeft), ($.y += s.clientTop))
                            : _ && ($.x = m(_))),
                    {
            ...
            function or(u) {
                ...
                return (
                    O(P || b).direction === 'rtl' &&
                        ($ += gt(b.clientWidth, P ? P.clientWidth : 0) - k),
        ...
        $o = Bo((e) => {
            ...
            function v(g) {
                var w,
                    C = T(g),
                    F = C[0];
                return !(F == null || (w = F.ownerDocument) == null) && w.body
                    ? F.ownerDocument
                    : document;
            }
            function p(g, w) {
            ...
            function ze() {
                ...
                (g - I < 20 && ((M.isTouch = !1), document.removeEventListener('mousemove', ze)),
                    (I = g));
            }
            function Rt() {
            ...
            function ar(g) {
                ...
                function q(W, H) {
                    var be = Xt(w),
                        ...
                        ye = be.arrow;
                    (H.theme
                        ? le.setAttribute('data-theme', H.theme)
...
`,
    ...
    var zo = ({ id: e }) => ({
        ...
        setUpTextSelectionClosePrevention() {
            ...
            let a = (c) =>
                !c.target.closest(t) && (c.target.closest(r) || c.target.closest('body'));
