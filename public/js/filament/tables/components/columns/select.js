    ...
    Xi = function (t) {
        function e(s, r) {
            return function (a, l, c, f) {
                ...
                return (
                    s === !0 || (typeof s == 'string' && s === h) || (s.join && s.indexOf(h) > -1)
                );
            };
        }
        var n = {},
        ...
        if (!y) {
            ...
            ((y = u.cloneNode(!0)),
                ...
                b(
                    y,
                    'transform-origin',
                    (_i / parseInt(y.style.width)) * 100 +
                        '% ' +
                        (Ri / parseInt(y.style.height)) * 100 +
                        '%'
                ));
        }
    },
        ...
        function w(T) {
            return (
                ...
                T &&
                    ...
                    g !== h &&
                        (Z(u, V ? V.options.ghostClass : c.options.ghostClass, !1),
                        Z(u, a.ghostClass, !0)),
        ...
        if (
            ...
            c &&
                ...
                (f
                    ? d || (r = P !== I)
                    : V === this ||
                      ((this.lastPutMode = de.checkPull(this, c, u, t)) &&
...
function Kn(i, t, e, n, o, s, r, a) {
    ...
    if (!r) {
        if (a && ge < c * o) {
            if ((!Zt && (Qt === 1 ? l > f + (c * s) / 2 : l < d - (c * s) / 2) && (Zt = !0), Zt))
                h = !0;
