            ...
            <div class="shop-filtre">
                <form method="GET" action="{{ url('/boutique') }}" id="shop-filtre-form">
                    <ul class="shop-filtre__links">
                        <li>
                            <select name="genre" class="shop-filtre__link" onchange="this.form.submit()">
                        ...
                        <li>
                            <select name="age_range" class="shop-filtre__link" onchange="this.form.submit()">
                                ...
                                '+18ans'
                                    ...
                                    <option value="{{ $age }}" @selected (request('age_range') === $age)>
                                        {{ $age }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <li>
                            <select name="price" class="shop-filtre__link" onchange="this.form.submit()">
                        ...
                        @if (request('genre') || request('age_range') || request('price'))
                            <li>
                                <a href="{{ url('/boutique') }}" class="shop-filtre__link shop-filtre__link--reset"
                                    >Réinitialiser</a
                                >
                            </li>
                        @endif
