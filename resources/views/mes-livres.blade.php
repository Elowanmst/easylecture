                ...
                <article class="card product-card">
                    ...
                    <div class="product-card__body">
                        ...
                        <div class="product-card__button">
                            @if ($book->pdf)
                                <a href="{{ route('library.read', $book) }}" class="button button--primary button__card">Lire</a>
                            @else
                                <span class="button button--secondary button__card" aria-disabled="true">Bientôt disponible</span>
                            @endif
                        </div>
                    </div>
                </article>
