    ...
    <div class="container">
        <div class="welcome">
            <div class="welcome__text">
                ...
                <p>Accède à ta bibliothèque numérique en un clic. Découvre des centaines d'<span class="text-highlight">ebooks</span> organisés par genre, trouve rapidement ce qui t'intéresse, et lis où tu veux, quand tu veux. Plus de recherches interminables, plus de complications — juste toi, un livre, et une expérience fluide pensée pour les lecteurs modernes.</p>
