...
<div class="container--large reader">
    ...
    <div class="reader__head">
        ...
        <a href="{{ asset('storage/' . $book->pdf) }}" target="_blank" rel="noopener" class="button button--primary">Ouvrir en plein écran</a>
    </div>
    ...
    <div class="reader__viewer">
        <iframe
            ...
            <p>Votre navigateur ne peut pas afficher le PDF.
                <a href="{{ asset('storage/' . $book->pdf) }}" target="_blank" rel="noopener">Cliquez ici pour le télécharger</a>.
            </p>
        </iframe>
    </div>
